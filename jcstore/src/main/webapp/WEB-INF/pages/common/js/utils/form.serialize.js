...
define(function(require, exports, module) {
	module.exports =  {
	     ...
	     */
	    checkAll : function(ptag, checkedtag) {
	    	var len = $(checkedtag).length;
	    	$(ptag).click(function(){
	    		if (this.checked) {
	    			$(checkedtag).prop('checked',true).trigger("change",['child',true]);
	    			$(ptag).prop('checked',true)
	    		}else{
	    			$(checkedtag).prop('checked',false).trigger("change",['child',false]);
	    			$(ptag).prop('checked',false)
	    		}
	    		
	    	})

	    	$(checkedtag).click(function(){
	    		if($(checkedtag+":checked").length==len)
	    		{
	    			$(ptag).prop('checked',true).trigger("change",['parent',true]);
	    		}else{
	    			$(ptag).prop('checked',false).trigger("change",['parent',false]);
	    		}
	    	});
	    },
	    /**
