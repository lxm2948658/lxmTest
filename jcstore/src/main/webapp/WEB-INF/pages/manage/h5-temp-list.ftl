...
<body>
	...
	<div class="wrapper clearfix">
		...
		<div class="main-body">
			<div class="ml30">
                <a href="javascript:void(0)" class="btn-search blue font-white mb30 dpib add">新增模板</a>
	...
	<script>
        seajs.use("manage/controller/h5-temp-list");
	</script>
	<script id="addDialog" type="text/x-handlebars-template">
		<form id='H5from' class="H5from">
			<div class="form-group">
				<label class=''>标题：</label>
				<input id='title' class='' name='title' type='text' value=''/>
			...
			<div class="form-group mt20">	
				<label>图片：</label>
				<div class='left' id='uploadDiv' class='uploadDiv'>
					...
					<span class='tips'>建议尺寸200像素*140像素</span>
			...
			<div class="form-group mt10">
				<div class='inner'>
					...
					<span>1、先使用H5平台制作H5模板。</span>
				</div>
				<div class='inner'>
					<label class=''> </label>
					<span class=''>2、制作完成获取链接后输入链接开始配置。</span>
				</div>	
				<div class='inner'>
					<label class=''> </label>
					<span class=''>3、配置成功后，客户在APP端自动生成模板。</span>
				</div>
			</div>
		</form>		
	</script>
